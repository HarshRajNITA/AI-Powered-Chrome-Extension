...
document.addEventListener('DOMContentLoaded', () => {
    ...
    chrome.storage.local.get('selectedText', async ({ selectedText }) => {
        ...
        if (selectedText) {
            ...
            document.querySelector('.details-container').innerHTML = "<h6>Nothing to show</h6>"
        }
    })
})